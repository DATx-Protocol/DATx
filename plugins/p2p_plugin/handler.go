...
func NewProtocolManager(protocolVersions []uint, networkId uint64, peers *peerSet, chainDb db.Database, quitSync chan struct{}, wg *sync.WaitGroup) (*ProtocolManager, error) {
