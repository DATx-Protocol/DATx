...
namespace datxos { namespace chain {
   ...
   enum object_type
   {
      ...
      account_control_history_object_type,     ///< Defined by history_accessory
      UNUSED_account_transaction_history_object_type,
      UNUSED_transaction_history_object_type,
      public_key_history_object_type,          ///< Defined by history_accessory
      ...
      account_history_object_type,              ///< Defined by history_accessory
      action_history_object_type,               ///< Defined by history_accessory
...
FC_REFLECT( datxos::chain::void_t, )
