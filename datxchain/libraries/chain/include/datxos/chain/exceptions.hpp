...
#define DATX_ASSERT( expr, exc_type, FORMAT, ... )                \
   FC_MULTILINE_MACRO_BEGIN                                           \
   if( !(expr) )                                                      \
      FC_THROW_EXCEPTION( exc_type, FORMAT, __VA_ARGS__ );            \
   FC_MULTILINE_MACRO_END

#define DATX_THROW( exc_type, FORMAT, ... ) \
    throw exc_type( FC_LOG_MESSAGE( error, FORMAT, __VA_ARGS__ ) );

/**
 * Macro inspired from FC_RETHROW_EXCEPTIONS
 * The main difference here is that if the exception caught isn't of type "datxos::chain::chain_exception"
 * This macro will rethrow the exception as the specified "exception_type"
 */
#define DATX_RETHROW_EXCEPTIONS(exception_type, FORMAT, ... ) \
   catch (datxos::chain::chain_exception& e) { \
 ...
 * This macro will rethrow the exception as the specified "exception_type"
 */
#define DATX_CAPTURE_AND_RETHROW( exception_type, ... ) \
   catch (datxos::chain::chain_exception& e) { \
...
#define DATX_RECODE_EXC( cause_type, effect_type ) \
...
namespace datxos { namespace chain {
   ...
   FC_DECLARE_DERIVED_EXCEPTION( action_validate_exception, chain_exception,
      ...
      FC_DECLARE_DERIVED_EXCEPTION( datxos_assert_message_exception, action_validate_exception,
                                    3050003, "datxos_assert_message assertion failure" )
      FC_DECLARE_DERIVED_EXCEPTION( datxos_assert_code_exception, action_validate_exception,
                                    3050004, "datxos_assert_code assertion failure" )
   ...
   FC_DECLARE_DERIVED_EXCEPTION( accessory_exception, chain_exception,
                                 3110000, "Accessory exception" )

      FC_DECLARE_DERIVED_EXCEPTION( missing_core_api_accessory_exception,           accessory_exception,
                                    3110001, "Missing Chain API Accessory" )
      FC_DECLARE_DERIVED_EXCEPTION( missing_wallet_api_accessory_exception,          accessory_exception,
                                    3110002, "Missing Wallet API Accessory" )
      FC_DECLARE_DERIVED_EXCEPTION( missing_history_api_accessory_exception,         accessory_exception,
                                    3110003, "Missing History API Accessory" )
      FC_DECLARE_DERIVED_EXCEPTION( missing_p2p_net_api_accessory_exception,             accessory_exception,
                                    3110004, "Missing Net API Accessory" )
      FC_DECLARE_DERIVED_EXCEPTION( missing_core_accessory_exception,               accessory_exception,
                                    3110005, "Missing Chain Accessory" )
      FC_DECLARE_DERIVED_EXCEPTION( accessory_config_exception,               accessory_exception,
                                    3110006, "Incorrect accessory configuration" )
