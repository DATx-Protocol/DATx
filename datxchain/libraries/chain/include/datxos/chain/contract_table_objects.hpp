...
#include <datxos/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(datxos::chain::table_id_object, datxos::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(datxos::chain::key_value_object, datxos::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(datxos::chain::index64_object, datxos::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(datxos::chain::index128_object, datxos::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(datxos::chain::index256_object, datxos::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(datxos::chain::index_double_object, datxos::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(datxos::chain::index_long_double_object, datxos::chain::index_long_double_index)

FC_REFLECT(datxos::chain::table_id_object, (id)(code)(scope)(table) )
FC_REFLECT(datxos::chain::key_value_object, (id)(t_id)(primary_key)(value)(payer) )
