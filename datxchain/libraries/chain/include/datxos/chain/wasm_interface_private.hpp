...
#include <datxos/chain/webassembly/wavm.hpp>
#include <datxos/chain/webassembly/binaryen.hpp>
...
using namespace fc;
using namespace datxos::chain::webassembly;
using namespace IR;
...
#define _REGISTER_INJECTED_INTRINSIC(R, CLS, INFO)\
   BOOST_PP_CAT(BOOST_PP_OVERLOAD(_REGISTER_INTRINSIC, _UNWRAP_SEQ INFO) _EXPAND_ARGS(CLS, DATXOS_INJECTED_MODULE_NAME, INFO), BOOST_PP_EMPTY())
