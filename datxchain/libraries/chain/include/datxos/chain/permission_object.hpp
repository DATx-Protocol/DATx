...
CHAINBASE_SET_INDEX_TYPE(datxos::chain::permission_object, datxos::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(datxos::chain::permission_usage_object, datxos::chain::permission_usage_index)

FC_REFLECT(chainbase::oid<datxos::chain::permission_object>, (_id))
FC_REFLECT(datxos::chain::permission_object, (id)(usage_id)(parent)(owner)(name)(last_updated)(auth))

FC_REFLECT(chainbase::oid<datxos::chain::permission_usage_object>, (_id))
FC_REFLECT(datxos::chain::permission_usage_object, (id)(last_used))
