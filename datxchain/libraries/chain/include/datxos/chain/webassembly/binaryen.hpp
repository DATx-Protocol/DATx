...
#include <datxos/chain/webassembly/runtime_interface.hpp>
...
namespace datxos { namespace chain { namespace webassembly { namespace binaryen {

using namespace fc;
using namespace wasm;
using namespace datxos::chain::webassembly::common;
...
class binaryen_runtime : public datxos::chain::wasm_runtime_interface {
   public:
      binaryen_runtime();
...
#define _REGISTER_BINARYEN_INTRINSIC(CLS, MOD, METHOD, WASM_SIG, NAME, SIG)\
   static datxos::chain::webassembly::binaryen::intrinsic_registrator _INTRINSIC_NAME(__binaryen_intrinsic_fn, __COUNTER__) (\
      MOD "." NAME,\
      datxos::chain::webassembly::binaryen::intrinsic_function_invoker_wrapper<SIG>::type::fn<&CLS::METHOD>()\
   );\


} } } }// datxos::chain::webassembly::wavm
