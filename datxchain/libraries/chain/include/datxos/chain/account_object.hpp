...
namespace datxos { namespace chain {
   ...
   class account_object : public chainbase::object<account_object_type, account_object> {
      ...
      void set_abi( const datxos::chain::abi_def& a ) {
         abi.resize( fc::raw::pack_size( a ) );
         fc::datastream<char*> ds( abi.data(), abi.size() );
         fc::raw::pack( ds, a );
      }

      datxos::chain::abi_def get_abi()const {
         datxos::chain::abi_def a;
...
CHAINBASE_SET_INDEX_TYPE(datxos::chain::account_object, datxos::chain::account_index)
CHAINBASE_SET_INDEX_TYPE(datxos::chain::account_sequence_object, datxos::chain::account_sequence_index)


FC_REFLECT(datxos::chain::account_object, (name)(vm_type)(vm_version)(code_version)(code)(creation_date))
