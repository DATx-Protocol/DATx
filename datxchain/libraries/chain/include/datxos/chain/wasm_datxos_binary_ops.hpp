...
namespace datxos { namespace chain { namespace wasm_ops {
...
struct field_specific_params {
   ...
   static void pack(instruction_stream* stream, Field& f) { return datxos::chain::wasm_ops::pack(stream, f); }
   static auto to_string(Field& f) { return std::string(" ")+
                                       datxos::chain::wasm_ops::to_string(f); }
};
template <>
...
template <class Op_Types>
struct DATXOS_OperatorDecoderStream
{
   DATXOS_OperatorDecoderStream(const std::vector<U8>& codeBytes)
...
template <class Op_Types>
const std::vector<instr*>* DATXOS_OperatorDecoderStream<Op_Types>::_cached_ops;

}}} // namespace datxos, chain, wasm_ops

FC_REFLECT_TEMPLATE( (typename T), datxos::chain::wasm_ops::block< T >, (code)(rt) )
FC_REFLECT( datxos::chain::wasm_ops::memarg, (a)(o) )
FC_REFLECT( datxos::chain::wasm_ops::blocktype, (result) )
FC_REFLECT( datxos::chain::wasm_ops::memoryoptype, (end) )
