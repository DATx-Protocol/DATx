...
FC_REFLECT( datxos::chain::type_def                         , (new_type_name)(type) )
FC_REFLECT( datxos::chain::field_def                        , (name)(type) )
FC_REFLECT( datxos::chain::struct_def                       , (name)(base)(fields) )
FC_REFLECT( datxos::chain::action_def                       , (name)(type)(ricardian_contract) )
FC_REFLECT( datxos::chain::table_def                        , (name)(index_type)(key_names)(key_types)(type) )
FC_REFLECT( datxos::chain::clause_pair                      , (id)(body) )
FC_REFLECT( datxos::chain::error_message                    , (error_code)(error_msg) )
FC_REFLECT( datxos::chain::abi_def                          , (version)(types)(structs)(actions)(tables)
