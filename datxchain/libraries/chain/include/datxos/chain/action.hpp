...
namespace datxos { namespace chain {
    ...
    *  In the context of datxos, every action is dispatched to the handler defined
...
FC_REFLECT( datxos::chain::permission_level, (actor)(permission) )
FC_REFLECT( datxos::chain::action, (account)(name)(authorization)(data) )
