...
FC_REFLECT( datxos::chain::base_action_trace,
                    (receipt)(act)(elapsed)(cpu_usage)(console)(total_cpu_usage)(trx_id) )

FC_REFLECT_DERIVED( datxos::chain::action_trace,
                    (datxos::chain::base_action_trace), (inline_traces) )

FC_REFLECT( datxos::chain::transaction_trace, (id)(receipt)(elapsed)(net_usage)(scheduled)
