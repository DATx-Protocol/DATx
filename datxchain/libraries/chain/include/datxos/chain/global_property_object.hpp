...
#include <datxos/chain/block_timestamp.hpp>
#include <datxos/chain/chain_config.hpp>
#include <datxos/chain/producer_schedule.hpp>
#include <datxos/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(datxos::chain::global_property_object, datxos::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(datxos::chain::dynamic_global_property_object,
                         datxos::chain::dynamic_global_property_multi_index)

FC_REFLECT(datxos::chain::dynamic_global_property_object,
           (global_action_sequence)
          )

FC_REFLECT(datxos::chain::global_property_object,
