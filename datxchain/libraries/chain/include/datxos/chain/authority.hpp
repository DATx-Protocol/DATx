...
FC_REFLECT(datxos::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(datxos::chain::key_weight, (key)(weight) )
FC_REFLECT(datxos::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(datxos::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(datxos::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
