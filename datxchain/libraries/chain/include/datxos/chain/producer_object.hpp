...
CHAINBASE_SET_INDEX_TYPE(datxos::chain::producer_object, datxos::chain::producer_multi_index)

FC_REFLECT(datxos::chain::producer_object::id_type, (_id))
FC_REFLECT(datxos::chain::producer_object, (id)(owner)(last_aslot)(signing_key)(total_missed)(last_confirmed_block_num)
           (configuration))
