#pragma once
#include <datxos/chain/block_header.hpp>
...
FC_REFLECT_ENUM( datxos::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(datxos::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(datxos::chain::transaction_receipt, (datxos::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(datxos::chain::signed_block, (datxos::chain::signed_block_header), (transactions)(block_extensions) )
