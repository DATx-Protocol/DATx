...
CHAINBASE_SET_INDEX_TYPE(datxos::chain::permission_link_object, datxos::chain::permission_link_index)

FC_REFLECT(datxos::chain::permission_link_object, (id)(account)(code)(message_type)(required_permission))
