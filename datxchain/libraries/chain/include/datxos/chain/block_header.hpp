...
FC_REFLECT(datxos::chain::block_header, 
           (timestamp)(producer)(confirmed)(previous)
           (transaction_mroot)(action_mroot)
           (schedule_version)(new_producers)(header_extensions))

FC_REFLECT_DERIVED(datxos::chain::signed_block_header, (datxos::chain::block_header), (producer_signature))
FC_REFLECT(datxos::chain::header_confirmation,  (block_id)(producer)(producer_signature) )
