...
CHAINBASE_SET_INDEX_TYPE(datxos::chain::block_summary_object, datxos::chain::block_summary_multi_index)

FC_REFLECT( datxos::chain::block_summary_object, (block_id) )
