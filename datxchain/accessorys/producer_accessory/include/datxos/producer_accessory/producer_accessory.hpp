...
#include <datxos/http_client_accessory/http_client_accessory.hpp>
...
class producer_accessory : public appbase::accessory<producer_accessory> {
public:
   APPBASE_accessory_REQUIRES((core_accessory)(http_client_accessory))
   ...
   virtual void accessory_initialize(const boost::program_options::variables_map& options);
   virtual void accessory_startup();
   virtual void accessory_shutdown();
...
private:
   std::shared_ptr<class producer_accessory_impl> my;
};

} //datxos

FC_REFLECT(datxos::producer_accessory::runtime_options, (max_transaction_time)(max_irreversible_block_age)(produce_time_offset_us)(last_block_time_offset_us)(subjective_cpu_leeway_us)(incoming_defer_ratio));
FC_REFLECT(datxos::producer_accessory::greylist_params, (accounts));
FC_REFLECT(datxos::producer_accessory::whitelist_blacklist, (actor_whitelist)(actor_blacklist)(contract_whitelist)(contract_blacklist)(action_blacklist)(key_blacklist) )
