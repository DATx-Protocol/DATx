...
CHAINBASE_SET_INDEX_TYPE( datxos::account_control_history_object, datxos::account_control_history_multi_index )

FC_REFLECT( datxos::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
