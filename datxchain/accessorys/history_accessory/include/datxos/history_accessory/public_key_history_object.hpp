...
CHAINBASE_SET_INDEX_TYPE( datxos::public_key_history_object, datxos::public_key_history_multi_index )

FC_REFLECT( datxos::public_key_history_object, (public_key)(name)(permission) )
