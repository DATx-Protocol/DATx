...
#include <datxos/wallet_accessory/wallet_api.hpp>
...
class soft_wallet final : public wallet_api
{
   public:
       ...
       *
       * example: remove_key DATX6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
       *
...
FC_REFLECT( datxos::wallet::wallet_data, (cipher_keys) )

FC_REFLECT( datxos::wallet::plain_keys, (checksum)(keys) )
