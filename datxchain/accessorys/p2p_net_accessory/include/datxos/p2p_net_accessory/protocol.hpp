...
FC_REFLECT( datxos::select_ids<fc::sha256>, (mode)(pending)(ids) )
FC_REFLECT( datxos::chain_size_message,
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id))
FC_REFLECT( datxos::handshake_message,
            (network_version)(chain_id)(node_id)(key)
            (time)(token)(sig)(p2p_address)
            (last_irreversible_block_num)(last_irreversible_block_id)
            (head_num)(head_id)
            (os)(agent)(generation) )
FC_REFLECT( datxos::go_away_message, (reason)(node_id) )
FC_REFLECT( datxos::time_message, (org)(rec)(xmt)(dst) )
FC_REFLECT( datxos::notice_message, (known_trx)(known_blocks) )
FC_REFLECT( datxos::request_message, (req_trx)(req_blocks) )
FC_REFLECT( datxos::sync_request_message, (start_block)(end_block) )
