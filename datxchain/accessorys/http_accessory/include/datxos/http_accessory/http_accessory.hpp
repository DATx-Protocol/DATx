...
namespace datxos {
   ...
   /**
    *  This accessory starts an HTTP server and dispatches queries to
    ...
    *  accessorys.  
    */
   class http_accessory : public appbase::accessory<http_accessory>
   {
      public:
        http_accessory();
        virtual ~http_accessory();
      ...
      private:
        std::unique_ptr<class http_accessory_impl> my;
   };
...
FC_REFLECT(datxos::error_results::error_info::error_detail, (message)(file)(line_number)(method))
FC_REFLECT(datxos::error_results::error_info, (code)(name)(what)(details))
FC_REFLECT(datxos::error_results, (code)(message)(error))
