...
class extract : public contract
{
  ...
  public:
    ...
    typedef datxos::multi_index<N(success), success,indexed_by<N(fixed_key), const_mem_fun<success, key256, &success::by_fixed_key>>> successtrxs;
    ...
    typedef datxos::multi_index<N(expiration), expiration,indexed_by<N(fixed_key), const_mem_fun<expiration, key256, &expiration::by_fixed_key>>> expirations;
    ...
    typedef datxos::multi_index<N(verifier), verifier> verifiers;
