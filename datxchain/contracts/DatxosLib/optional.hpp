   ...
   class optional {
      public:
         ...
         */
          ...
          */
         T&       operator*()      { datxos_assert(_valid, "dereference of empty optional"); return ref(); }
          ...
          * @return T& - Contained value
          */
         const T& operator*()const { datxos_assert(_valid, "dereference of empty optional"); return ref(); }
         ...
         T*       operator->()
         {
            datxos_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         *  @return datxos::datastream<Stream>& - Reference to the datastream
         */
         template<typename Stream>
         friend inline datxos::datastream<Stream>& operator>> (datxos::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         */
         template<typename Stream>
         friend inline datxos::datastream<Stream>& operator<< (datxos::datastream<Stream>& ds, const optional& op)
         {
