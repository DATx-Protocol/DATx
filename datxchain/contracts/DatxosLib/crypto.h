 ...
 *  datxos::print("sha256 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  datxos::print("sha1 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  datxos::print("sha512 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  datxos::print("ripemod160 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  datx_assert( calc_hash == hash, "invalid hash" );
 *  @endcode
 */
 ...
 *  datxos::print("pub key matches the pub key generated from digest");
 *  @endcode
 */
