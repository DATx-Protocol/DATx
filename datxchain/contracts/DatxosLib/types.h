 ...
 * @details DATXOS Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
...
/**
 * @brief DATXOS Signature
 * @details DATXOS Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of DATXOS Transaction Id
 * @details Type of DATXOS Transaction Id. It is 256-bit hash
 */
