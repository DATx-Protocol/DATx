 ...
 * @ingroup types
 * @brief Defines contract type which is %base class for every DATXOS contract
 * 
 * @{
 * 
 */
...
/**
 * @brief %Base class for DATXOS contract.
 * @details %Base class for DATXOS contract. %A new contract should derive from this class, so it can make use of DATXOS_ABI macro.
 */
class contract {
   public:
      /**
