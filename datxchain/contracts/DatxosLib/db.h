 ...
 *  @brief Defines an interface to DATXOS database
 *  @ingroup database
 *
 *  @details
 *  DATXOS organizes data according to the following broad structure:
 ...
 *  @ingroup database
 *
 *  @details Database C API provides low level interface to DATXOS database.
 *
...
/**
  ...
  *  datxos_assert(itr >= 0, "Alice cannot be removed since she was already not found in the table");
  *  db_remove_i64(itr);
  *  @endcode
  */
...
/**
  ...
  *  datxos_assert(len <= 50, "buffer to small to store retrieved record");
...
/**
  ...
  *  datxos_assert(end_itr < -1, "Charlie was not the last entry in the table");
  *  @endcode
  */
