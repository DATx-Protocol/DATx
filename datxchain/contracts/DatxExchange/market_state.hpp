...
namespace datxos {
   ...
   typedef datxos::multi_index<N(margins), margin_position,
           indexed_by<N(callprice), datxos::const_mem_fun<margin_position, uint64_t, &margin_position::get_call> >
   > margins;
   ...
   typedef datxos::multi_index<N(loans), loan_position> loans;
