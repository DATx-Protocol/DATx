...
namespace datxio { namespace detail {
...
FC_REFLECT(datxio::detail::faucet_testnet_empty, );
FC_REFLECT(datxio::detail::faucet_testnet_keys, (owner)(active));
FC_REFLECT(datxio::detail::faucet_testnet_create_account_params, (account)(keys));
FC_REFLECT(datxio::detail::faucet_testnet_create_account_alternates_response, (alternates)(message));
FC_REFLECT(datxio::detail::faucet_testnet_create_account_rate_limited_response, (message));
...
struct faucet_testp2p_net_plugin_impl {
   ...
   results_pair find_alternates(const std::string& new_account_name) {
      ...
      const datxio::detail::faucet_testnet_create_account_alternates_response response{
   ...
   results_pair create_account(const std::string& new_account_name, const fc::crypto::public_key& owner_pub_key, const fc::crypto::public_key& active_pub_key) {
      ...
      {
         datxio::detail::faucet_testnet_create_account_rate_limited_response response{
   ...
   results_pair create_faucet_account(const std::string& body) {
      const datxio::detail::faucet_testnet_create_account_params params = fc::json::from_string(body).as<datxio::detail::faucet_testnet_create_account_params>();
