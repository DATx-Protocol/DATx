...
FC_REFLECT(datxio::error_results::error_info::error_detail, (message)(file)(line_number)(method))
FC_REFLECT(datxio::error_results::error_info, (code)(name)(what)(details))
FC_REFLECT(datxio::error_results, (code)(message)(error))
