 ...
 */
#include <datxio/p2p_net_api_plugin/p2p_net_api_plugin.hpp>
...
namespace datxio { namespace detail {
  struct p2p_net_api_plugin_empty {};
}}

FC_REFLECT(datxio::detail::p2p_net_api_plugin_empty, );

namespace datxio {

static appbase::abstract_plugin& _p2p_net_api_plugin = app().register_plugin<p2p_net_api_plugin>();
...
#define INVOKE_V_R(api_handle, call_name, in_param) \
     ...
     datxio::detail::p2p_net_api_plugin_empty result;
...
void p2p_net_api_plugin::plugin_startup() {
   ilog("starting p2p_net_api_plugin");
   // lifetime of plugin is lifetime of application
   auto& net_mgr = app().get_plugin<p2p_net_plugin>();
...
void p2p_net_api_plugin::plugin_initialize(const variables_map& options) {
   try {
