...
#include <datxio/history_plugin/account_control_history_object.hpp>
...
CHAINBASE_SET_INDEX_TYPE(datxio::account_history_object, datxio::account_history_index)
CHAINBASE_SET_INDEX_TYPE(datxio::action_history_object, datxio::action_history_index)
...
namespace datxio {
   ...
   namespace history_apis { 
      read_only::get_actions_result read_only::get_actions( const read_only::get_actions_params& params )const {
        ...
        DATX_ASSERT( end >= start, chain::plugin_exception, "end position is earlier than start position" );
