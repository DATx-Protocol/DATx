...
CHAINBASE_SET_INDEX_TYPE( datxio::account_control_history_object, datxio::account_control_history_multi_index )

FC_REFLECT( datxio::account_control_history_object, (controlled_account)(controlled_permission)(controlling_account) )
