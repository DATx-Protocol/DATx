...
CHAINBASE_SET_INDEX_TYPE( datxio::public_key_history_object, datxio::public_key_history_multi_index )

FC_REFLECT( datxio::public_key_history_object, (public_key)(name)(permission) )
