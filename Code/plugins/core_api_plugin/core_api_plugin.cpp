 ...
 */
#include <datxio/core_api_plugin/core_api_plugin.hpp>
...
static appbase::abstract_plugin& _core_api_plugin = app().register_plugin<core_api_plugin>();

using namespace datxio;

class core_api_plugin_impl {
public:
   core_api_plugin_impl(controller& db)
      : db(db) {}
...
core_api_plugin::core_api_plugin(){}
core_api_plugin::~core_api_plugin(){}

void core_api_plugin::set_program_options(options_description&, options_description&) {}
void core_api_plugin::plugin_initialize(const variables_map&) {}
...
void core_api_plugin::plugin_startup() {
   ilog( "starting core_api_plugin" );
   my.reset(new core_api_plugin_impl(app().get_plugin<core_plugin>().chain()));
   auto ro_api = app().get_plugin<core_plugin>().get_read_only_api();
   auto rw_api = app().get_plugin<core_plugin>().get_read_write_api();
...
void core_api_plugin::plugin_shutdown() {}
