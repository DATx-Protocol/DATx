...
const char* history_plugin_advice_text = _("\033[32mPlease ensure that the \033[2mdatxio::history_plugin\033[22m is enabled on the RPC node you are connecting to and that an account involved in this transaction was configured in the \033[2mfilter-on\033[22m setting.\033[0m\n");
...
You can refer to contracts/DatxioLib/transaction.hpp for reference)=====";
...
const char* error_advice_tx_duplicate =  "You can try embedding datxio nonce action inside your transaction to ensure uniqueness.";
...
bool print_recognized_errors(const fc::exception& e, const bool verbose_errors) {
   ...
   // refer to libraries/chain/include/datxio/chain/exceptions.hpp
