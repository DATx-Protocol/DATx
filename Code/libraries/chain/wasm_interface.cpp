#include <datxio/chain/wasm_interface.hpp>
#include <datxio/chain/apply_context.hpp>
#include <datxio/chain/controller.hpp>
#include <datxio/chain/transaction_context.hpp>
#include <datxio/chain/producer_schedule.hpp>
#include <datxio/chain/exceptions.hpp>
#include <boost/core/ignore_unused.hpp>
#include <datxio/chain/authorization_manager.hpp>
#include <datxio/chain/resource_limits.hpp>
#include <datxio/chain/wasm_interface_private.hpp>
#include <datxio/chain/wasm_datxio_validation.hpp>
#include <datxio/chain/wasm_datxio_injection.hpp>
#include <datxio/chain/global_property_object.hpp>
#include <datxio/chain/account_object.hpp>
...
class softfloat_api : public context_aware_api {
   public:
      ...
      float _datxio_f32_max( float af, float bf ) {
         float32_t a = to_softfloat32(af);
         float32_t b = to_softfloat32(bf);
         if (is_nan(a)) {
            return af;
      ...
      float _datxio_f32_copysign( float af, float bf ) {
         float32_t a = to_softfloat32(af);
         float32_t b = to_softfloat32(bf);
      ...
      // float unops
      float _datxio_f32_abs( float af ) {
         float32_t a = to_softfloat32(af);
         a.v &= ~(1 << 31);
         return from_softfloat32(a);
      }
      float _datxio_f32_neg( float af ) {
         float32_t a = to_softfloat32(af);
      ...
      float _datxio_f32_floor( float af ) {
         float32_t a = to_softfloat32(af);
         int e = (int)(a.v >> 23 & 0xFF) - 0X7F;
         uint32_t m;
         if (e >= 23)
      ...
      float _datxio_f32_trunc( float af ) {
         float32_t a = to_softfloat32(af);
      ...
      float _datxio_f32_nearest( float af ) {
         float32_t a = to_softfloat32(af);
         int e = a.v>>23 & 0xff;
         int s = a.v>>31;
         float32_t y;
      ...
      // float relops
      bool _datxio_f32_eq( float a, float b ) {  return f32_eq( to_softfloat32(a), to_softfloat32(b) ); }
      bool _datxio_f32_ne( float a, float b ) { return !f32_eq( to_softfloat32(a), to_softfloat32(b) ); }
      bool _datxio_f32_lt( float a, float b ) { return f32_lt( to_softfloat32(a), to_softfloat32(b) ); }
      bool _datxio_f32_le( float a, float b ) { return f32_le( to_softfloat32(a), to_softfloat32(b) ); }
      bool _datxio_f32_gt( float af, float bf ) {
         float32_t a = to_softfloat32(af);
         float32_t b = to_softfloat32(bf);
         if (is_nan(a))
            return false;
      ...
      bool _datxio_f32_ge( float af, float bf ) {
         float32_t a = to_softfloat32(af);
         float32_t b = to_softfloat32(bf);
         if (is_nan(a))
            return false;
      ...
      double _datxio_f64_max( double af, double bf ) {
         float64_t a = to_softfloat64(af);
         float64_t b = to_softfloat64(bf);
         if (is_nan(a))
            return af;
      ...
      double _datxio_f64_copysign( double af, double bf ) {
         float64_t a = to_softfloat64(af);
         float64_t b = to_softfloat64(bf);
      ...
      // double unops
      double _datxio_f64_abs( double af ) {
         float64_t a = to_softfloat64(af);
         a.v &= ~(uint64_t(1) << 63);
         return from_softfloat64(a);
      }
      double _datxio_f64_neg( double af ) {
         float64_t a = to_softfloat64(af);
      ...
      double _datxio_f64_sqrt( double a ) {
         float64_t ret = f64_sqrt( to_softfloat64(a) );
         return from_softfloat64(ret);
      }
      // ceil, floor, trunc and nearest are lifted from libc
      double _datxio_f64_ceil( double af ) {
         float64_t a = to_softfloat64( af );
         float64_t ret;
         int e = a.v >> 52 & 0x7ff;
         float64_t y;
      ...
      double _datxio_f64_floor( double af ) {
         float64_t a = to_softfloat64( af );
         float64_t ret;
         int e = a.v >> 52 & 0x7FF;
         float64_t y;
      ...
      double _datxio_f64_trunc( double af ) {
         float64_t a = to_softfloat64( af );
      ...
      double _datxio_f64_nearest( double af ) {
         float64_t a = to_softfloat64( af );
         int e = (a.v >> 52 & 0x7FF);
         int s = a.v >> 63;
         float64_t y;
      ...
      // double relops
      bool _datxio_f64_eq( double a, double b ) { return f64_eq( to_softfloat64(a), to_softfloat64(b) ); }
      bool _datxio_f64_ne( double a, double b ) { return !f64_eq( to_softfloat64(a), to_softfloat64(b) ); }
      bool _datxio_f64_lt( double a, double b ) { return f64_lt( to_softfloat64(a), to_softfloat64(b) ); }
      bool _datxio_f64_le( double a, double b ) { return f64_le( to_softfloat64(a), to_softfloat64(b) ); }
      bool _datxio_f64_gt( double af, double bf ) {
         float64_t a = to_softfloat64(af);
         float64_t b = to_softfloat64(bf);
         if (is_nan(a))
            return false;
      ...
      bool _datxio_f64_ge( double af, double bf ) {
         float64_t a = to_softfloat64(af);
         float64_t b = to_softfloat64(bf);
         if (is_nan(a))
            return false;
      ...
      double _datxio_f32_promote( float a ) {
         return from_softfloat64(f32_to_f64( to_softfloat32(a)) );
      }
      float _datxio_f64_demote( double a ) {
         return from_softfloat32(f64_to_f32( to_softfloat64(a)) );
      }
      int32_t _datxio_f32_trunc_i32s( float af ) {
         float32_t a = to_softfloat32(af);
         if (_datxio_f32_ge(af, 2147483648.0f) || _datxio_f32_lt(af, -2147483648.0f))
            FC_THROW_EXCEPTION( datxio::chain::wasm_execution_error, "Error, f32.convert_s/i32 overflow" );

         if (is_nan(a))
            FC_THROW_EXCEPTION( datxio::chain::wasm_execution_error, "Error, f32.convert_s/i32 unrepresentable");
         return f32_to_i32( to_softfloat32(_datxio_f32_trunc( af )), 0, false );
      }
      int32_t _datxio_f64_trunc_i32s( double af ) {
         float64_t a = to_softfloat64(af);
         if (_datxio_f64_ge(af, 2147483648.0) || _datxio_f64_lt(af, -2147483648.0))
            FC_THROW_EXCEPTION( datxio::chain::wasm_execution_error, "Error, f64.convert_s/i32 overflow");
         if (is_nan(a))
            FC_THROW_EXCEPTION( datxio::chain::wasm_execution_error, "Error, f64.convert_s/i32 unrepresentable");
         return f64_to_i32( to_softfloat64(_datxio_f64_trunc( af )), 0, false );
      }
      uint32_t _datxio_f32_trunc_i32u( float af ) {
         float32_t a = to_softfloat32(af);
         if (_datxio_f32_ge(af, 4294967296.0f) || _datxio_f32_le(af, -1.0f))
            FC_THROW_EXCEPTION( datxio::chain::wasm_execution_error, "Error, f32.convert_u/i32 overflow");
         if (is_nan(a))
            FC_THROW_EXCEPTION( datxio::chain::wasm_execution_error, "Error, f32.convert_u/i32 unrepresentable");
         return f32_to_ui32( to_softfloat32(_datxio_f32_trunc( af )), 0, false );
      }
      uint32_t _datxio_f64_trunc_i32u( double af ) {
         float64_t a = to_softfloat64(af);
         if (_datxio_f64_ge(af, 4294967296.0) || _datxio_f64_le(af, -1.0))
            FC_THROW_EXCEPTION( datxio::chain::wasm_execution_error, "Error, f64.convert_u/i32 overflow");
         if (is_nan(a))
            FC_THROW_EXCEPTION( datxio::chain::wasm_execution_error, "Error, f64.convert_u/i32 unrepresentable");
         return f64_to_ui32( to_softfloat64(_datxio_f64_trunc( af )), 0, false );
      }
      int64_t _datxio_f32_trunc_i64s( float af ) {
         float32_t a = to_softfloat32(af);
         if (_datxio_f32_ge(af, 9223372036854775808.0f) || _datxio_f32_lt(af, -9223372036854775808.0f))
            FC_THROW_EXCEPTION( datxio::chain::wasm_execution_error, "Error, f32.convert_s/i64 overflow");
         if (is_nan(a))
            FC_THROW_EXCEPTION( datxio::chain::wasm_execution_error, "Error, f32.convert_s/i64 unrepresentable");
         return f32_to_i64( to_softfloat32(_datxio_f32_trunc( af )), 0, false );
      }
      int64_t _datxio_f64_trunc_i64s( double af ) {
         float64_t a = to_softfloat64(af);
         if (_datxio_f64_ge(af, 9223372036854775808.0) || _datxio_f64_lt(af, -9223372036854775808.0))
            FC_THROW_EXCEPTION( datxio::chain::wasm_execution_error, "Error, f64.convert_s/i64 overflow");
         if (is_nan(a))
            FC_THROW_EXCEPTION( datxio::chain::wasm_execution_error, "Error, f64.convert_s/i64 unrepresentable");

         return f64_to_i64( to_softfloat64(_datxio_f64_trunc( af )), 0, false );
      }
      uint64_t _datxio_f32_trunc_i64u( float af ) {
         float32_t a = to_softfloat32(af);
         if (_datxio_f32_ge(af, 18446744073709551616.0f) || _datxio_f32_le(af, -1.0f))
            FC_THROW_EXCEPTION( datxio::chain::wasm_execution_error, "Error, f32.convert_u/i64 overflow");
         if (is_nan(a))
            FC_THROW_EXCEPTION( datxio::chain::wasm_execution_error, "Error, f32.convert_u/i64 unrepresentable");
         return f32_to_ui64( to_softfloat32(_datxio_f32_trunc( af )), 0, false );
      }
      uint64_t _datxio_f64_trunc_i64u( double af ) {
         float64_t a = to_softfloat64(af);
         if (_datxio_f64_ge(af, 18446744073709551616.0) || _datxio_f64_le(af, -1.0))
            FC_THROW_EXCEPTION( datxio::chain::wasm_execution_error, "Error, f64.convert_u/i64 overflow");
         if (is_nan(a))
            FC_THROW_EXCEPTION( datxio::chain::wasm_execution_error, "Error, f64.convert_u/i64 unrepresentable");
         return f64_to_ui64( to_softfloat64(_datxio_f64_trunc( af )), 0, false );
      }
      float _datxio_i32_to_f32( int32_t a )  {
         return from_softfloat32(i32_to_f32( a ));
      }
      float _datxio_i64_to_f32( int64_t a ) {
         return from_softfloat32(i64_to_f32( a ));
      }
      float _datxio_ui32_to_f32( uint32_t a ) {
         return from_softfloat32(ui32_to_f32( a ));
      }
      float _datxio_ui64_to_f32( uint64_t a ) {
         return from_softfloat32(ui64_to_f32( a ));
      }
      double _datxio_i32_to_f64( int32_t a ) {
         return from_softfloat64(i32_to_f64( a ));
      }
      double _datxio_i64_to_f64( int64_t a ) {
         return from_softfloat64(i64_to_f64( a ));
      }
      double _datxio_ui32_to_f64( uint32_t a ) {
         return from_softfloat64(ui32_to_f64( a ));
      }
      double _datxio_ui64_to_f64( uint64_t a ) {
...
class crypto_api : public context_aware_api {
   public:
      ...
      template<class Encoder> auto encode(char* data, size_t datalen) {
         Encoder e;
         const size_t bs = datxio::chain::config::hashing_checktime_block_size;
         while ( datalen > bs ) {
            e.write( data, bs );
            data += bs;
            datalen -= bs;
...
public:
   ...
   // Kept as intrinsic rather than implementing on WASM side (using datxio_assert_message and strlen) because strlen is faster on native side.
   void datxio_assert( bool condition, null_terminated_ptr msg ) {
      if( BOOST_UNLIKELY( !condition ) ) {
         std::string message( msg );
         edump((message));
         DATX_THROW( datxio_assert_message_exception, "assertion failure with message: ${s}", ("s",message) );
      }
   }

   void datxio_assert_message( bool condition, array_ptr<const char> msg, size_t msg_len ) {
      if( BOOST_UNLIKELY( !condition ) ) {
   ...
   void datxio_assert_code( bool condition, uint64_t error_code ) {
      if( BOOST_UNLIKELY( !condition ) ) {
         edump((error_code));
         DATX_THROW( datxio_assert_code_exception,
                    "assertion failure with error code: ${error_code}", ("error_code", error_code) );
      }
   }

   void datxio_exit(int32_t code) {
...
REGISTER_INTRINSICS(context_free_system_api,
   (abort,                void()              )
   (datxio_assert,         void(int, int)      )
   (datxio_assert_message, void(int, int, int) )
   (datxio_assert_code,    void(int, int64_t)  )
   (datxio_exit,           void(int)           )
);
...
REGISTER_INJECTED_INTRINSICS(softfloat_api,
      (_datxio_f32_add,       float(float, float)    )
      (_datxio_f32_sub,       float(float, float)    )
      (_datxio_f32_mul,       float(float, float)    )
      (_datxio_f32_div,       float(float, float)    )
      (_datxio_f32_min,       float(float, float)    )
      (_datxio_f32_max,       float(float, float)    )
      (_datxio_f32_copysign,  float(float, float)    )
      (_datxio_f32_abs,       float(float)           )
      (_datxio_f32_neg,       float(float)           )
      (_datxio_f32_sqrt,      float(float)           )
      (_datxio_f32_ceil,      float(float)           )
      (_datxio_f32_floor,     float(float)           )
      (_datxio_f32_trunc,     float(float)           )
      (_datxio_f32_nearest,   float(float)           )
      (_datxio_f32_eq,        int(float, float)      )
      (_datxio_f32_ne,        int(float, float)      )
      (_datxio_f32_lt,        int(float, float)      )
      (_datxio_f32_le,        int(float, float)      )
      (_datxio_f32_gt,        int(float, float)      )
      (_datxio_f32_ge,        int(float, float)      )
      (_datxio_f64_add,       double(double, double) )
      (_datxio_f64_sub,       double(double, double) )
      (_datxio_f64_mul,       double(double, double) )
      (_datxio_f64_div,       double(double, double) )
      (_datxio_f64_min,       double(double, double) )
      (_datxio_f64_max,       double(double, double) )
      (_datxio_f64_copysign,  double(double, double) )
      (_datxio_f64_abs,       double(double)         )
      (_datxio_f64_neg,       double(double)         )
      (_datxio_f64_sqrt,      double(double)         )
      (_datxio_f64_ceil,      double(double)         )
      (_datxio_f64_floor,     double(double)         )
      (_datxio_f64_trunc,     double(double)         )
      (_datxio_f64_nearest,   double(double)         )
      (_datxio_f64_eq,        int(double, double)    )
      (_datxio_f64_ne,        int(double, double)    )
      (_datxio_f64_lt,        int(double, double)    )
      (_datxio_f64_le,        int(double, double)    )
      (_datxio_f64_gt,        int(double, double)    )
      (_datxio_f64_ge,        int(double, double)    )
      (_datxio_f32_promote,    double(float)         )
      (_datxio_f64_demote,     float(double)         )
      (_datxio_f32_trunc_i32s, int(float)            )
      (_datxio_f64_trunc_i32s, int(double)           )
      (_datxio_f32_trunc_i32u, int(float)            )
      (_datxio_f64_trunc_i32u, int(double)           )
      (_datxio_f32_trunc_i64s, int64_t(float)        )
      (_datxio_f64_trunc_i64s, int64_t(double)       )
      (_datxio_f32_trunc_i64u, int64_t(float)        )
      (_datxio_f64_trunc_i64u, int64_t(double)       )
      (_datxio_i32_to_f32,     float(int32_t)        )
      (_datxio_i64_to_f32,     float(int64_t)        )
      (_datxio_ui32_to_f32,    float(int32_t)        )
      (_datxio_ui64_to_f32,    float(int64_t)        )
      (_datxio_i32_to_f64,     double(int32_t)       )
      (_datxio_i64_to_f64,     double(int64_t)       )
      (_datxio_ui32_to_f64,    double(int32_t)       )
      (_datxio_ui64_to_f64,    double(int64_t)       )
);
...
std::istream& operator>>(std::istream& in, wasm_interface::vm_type& runtime) {
   ...
   in >> s;
   if (s == "wavm")
      runtime = datxio::chain::wasm_interface::vm_type::wavm;
   else if (s == "binaryen")
      runtime = datxio::chain::wasm_interface::vm_type::binaryen;
   else
