...
#include <datxio/chain/symbol.hpp>
...
namespace fc {
inline void to_variant(const datxio::chain::asset& var, fc::variant& vo) { vo = var.to_string(); }
inline void from_variant(const fc::variant& var, datxio::chain::asset& vo) {
   vo = datxio::chain::asset::from_string(var.get_string());
}
}

FC_REFLECT(datxio::chain::asset, (amount)(sym))
FC_REFLECT(datxio::chain::extended_asset, (quantity)(contract) )
