...
CHAINBASE_SET_INDEX_TYPE(datxio::chain::permission_link_object, datxio::chain::permission_link_index)

FC_REFLECT(datxio::chain::permission_link_object, (id)(account)(code)(message_type)(required_permission))
