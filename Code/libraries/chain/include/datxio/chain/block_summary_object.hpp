...
CHAINBASE_SET_INDEX_TYPE(datxio::chain::block_summary_object, datxio::chain::block_summary_multi_index)

FC_REFLECT( datxio::chain::block_summary_object, (block_id) )
