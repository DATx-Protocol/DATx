...
namespace datxio { namespace chain {
   ...
   class wasm_interface {
      public:
         ...
         //validates code -- does a WASM validation pass and checks the wasm against DATXIO specific constraints
      ...
      private:
         ...
         friend class datxio::chain::webassembly::common::intrinsics_accessor;
   };
...
FC_REFLECT_ENUM( datxio::chain::wasm_interface::vm_type, (wavm)(binaryen) )
