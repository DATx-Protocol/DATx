#pragma once
#include <datxio/chain/block_header.hpp>
...
FC_REFLECT_ENUM( datxio::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(datxio::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(datxio::chain::transaction_receipt, (datxio::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(datxio::chain::signed_block, (datxio::chain::signed_block_header), (transactions)(block_extensions) )
