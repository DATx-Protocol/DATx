...
#include <datxio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(datxio::chain::table_id_object, datxio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(datxio::chain::key_value_object, datxio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(datxio::chain::index64_object, datxio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(datxio::chain::index128_object, datxio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(datxio::chain::index256_object, datxio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(datxio::chain::index_double_object, datxio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(datxio::chain::index_long_double_object, datxio::chain::index_long_double_index)

FC_REFLECT(datxio::chain::table_id_object, (id)(code)(scope)(table) )
FC_REFLECT(datxio::chain::key_value_object, (id)(t_id)(primary_key)(value)(payer) )
