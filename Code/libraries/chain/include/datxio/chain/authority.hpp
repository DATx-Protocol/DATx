...
FC_REFLECT(datxio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(datxio::chain::key_weight, (key)(weight) )
FC_REFLECT(datxio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(datxio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(datxio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
