 ...
 * The main difference here is that if the exception caught isn't of type "datxio::chain::chain_exception"
...
#define DATX_RETHROW_EXCEPTIONS(exception_type, FORMAT, ... ) \
   catch (datxio::chain::chain_exception& e) { \
...
namespace datxio { namespace chain {
   ...
   FC_DECLARE_DERIVED_EXCEPTION( action_validate_exception, chain_exception,
      ...
      FC_DECLARE_DERIVED_EXCEPTION( datxio_assert_message_exception, action_validate_exception,
                                    3050003, "datxio_assert_message assertion failure" )
      FC_DECLARE_DERIVED_EXCEPTION( datxio_assert_code_exception, action_validate_exception,
                                    3050004, "datxio_assert_code assertion failure" )
