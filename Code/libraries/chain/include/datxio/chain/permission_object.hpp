...
CHAINBASE_SET_INDEX_TYPE(datxio::chain::permission_object, datxio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(datxio::chain::permission_usage_object, datxio::chain::permission_usage_index)

FC_REFLECT(chainbase::oid<datxio::chain::permission_object>, (_id))
FC_REFLECT(datxio::chain::permission_object, (id)(usage_id)(parent)(owner)(name)(last_updated)(auth))

FC_REFLECT(chainbase::oid<datxio::chain::permission_usage_object>, (_id))
FC_REFLECT(datxio::chain::permission_usage_object, (id)(last_used))
