...
namespace datxio { namespace chain { namespace resource_limits {
...
} } } /// datxio::chain::resource_limits

CHAINBASE_SET_INDEX_TYPE(datxio::chain::resource_limits::resource_limits_object,        datxio::chain::resource_limits::resource_limits_index)
CHAINBASE_SET_INDEX_TYPE(datxio::chain::resource_limits::resource_usage_object,         datxio::chain::resource_limits::resource_usage_index)
CHAINBASE_SET_INDEX_TYPE(datxio::chain::resource_limits::resource_limits_config_object, datxio::chain::resource_limits::resource_limits_config_index)
CHAINBASE_SET_INDEX_TYPE(datxio::chain::resource_limits::resource_limits_state_object,  datxio::chain::resource_limits::resource_limits_state_index)
