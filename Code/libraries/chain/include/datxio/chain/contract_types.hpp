...
using action_name    = datxio::chain::action_name;
...
FC_REFLECT( datxio::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( datxio::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( datxio::chain::setabi                           , (account)(abi) )
FC_REFLECT( datxio::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( datxio::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( datxio::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( datxio::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( datxio::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( datxio::chain::onerror                          , (sender_id)(sent_trx) )
