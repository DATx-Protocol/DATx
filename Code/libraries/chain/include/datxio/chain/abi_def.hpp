...
FC_REFLECT( datxio::chain::type_def                         , (new_type_name)(type) )
FC_REFLECT( datxio::chain::field_def                        , (name)(type) )
FC_REFLECT( datxio::chain::struct_def                       , (name)(base)(fields) )
FC_REFLECT( datxio::chain::action_def                       , (name)(type)(ricardian_contract) )
FC_REFLECT( datxio::chain::table_def                        , (name)(index_type)(key_names)(key_types)(type) )
FC_REFLECT( datxio::chain::clause_pair                      , (id)(body) )
FC_REFLECT( datxio::chain::error_message                    , (error_code)(error_msg) )
FC_REFLECT( datxio::chain::abi_def                          , (version)(types)(structs)(actions)(tables)
