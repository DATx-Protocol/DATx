...
FC_REFLECT( datxio::chain::base_action_trace,
                    (receipt)(act)(elapsed)(cpu_usage)(console)(total_cpu_usage)(trx_id) )

FC_REFLECT_DERIVED( datxio::chain::action_trace,
                    (datxio::chain::base_action_trace), (inline_traces) )

FC_REFLECT( datxio::chain::transaction_trace, (id)(receipt)(elapsed)(net_usage)(scheduled)
