...
#include <datxio/chain/block_summary_object.hpp>
#include <datxio/chain/global_property_object.hpp>
#include <datxio/chain/contract_table_objects.hpp>
#include <datxio/chain/generated_transaction_object.hpp>
#include <datxio/chain/transaction_object.hpp>
...
#define SET_APP_HANDLER( receiver, contract, action) \
   ...
   SET_APP_HANDLER( datxio, datxio, newaccount );
   SET_APP_HANDLER( datxio, datxio, setcode );
   SET_APP_HANDLER( datxio, datxio, setabi );
   SET_APP_HANDLER( datxio, datxio, updateauth );
   SET_APP_HANDLER( datxio, datxio, deleteauth );
   SET_APP_HANDLER( datxio, datxio, linkauth );
   SET_APP_HANDLER( datxio, datxio, unlinkauth );
/*
   SET_APP_HANDLER( datxio, datxio, postrecovery );
   SET_APP_HANDLER( datxio, datxio, passrecovery );
   SET_APP_HANDLER( datxio, datxio, vetorecovery );
*/

   SET_APP_HANDLER( datxio, datxio, canceldelay );
   ...
   void create_native_account( account_name name, const authority& owner, const authority& active, bool is_privileged = false ) {
      db.create<account_object>([&](auto& a) {
         ...
         if( name == config::system_account_name ) {
            a.set_abi(datxio_contract_abi(abi_def()));
         }
      });
