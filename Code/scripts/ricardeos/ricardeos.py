...
def main():
    if len(sys.argv) == 1:
        print('Please specify an operation of export or import: ./ricarddatx.py <import|export>')
        sys.exit(1)

    if sys.argv[1] == 'import':
        if len(sys.argv) != 4:
            print('Please specify a source and destination abi:')
            print('Usage: ./ricarddatx.py import /datx/contracts/contract/mycontract.abi /datx/contracts/contract/withricardian-mycontract.abi')
        ...
        if len(sys.argv) != 3:
            ...
            print('Usage: ./ricarddatx.py export /datx/contracts/contract/mycontract.abi')
