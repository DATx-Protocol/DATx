...
namespace datxio {
   ...
   struct margin_state {
      ...
      extended_asset unlend( double ishares ) {
         ...
         datxio_assert( interest_shares >= 0, "underflow" );
         datxio_assert( total_lendable.amount >= 0, "underflow" );

         return result;
      }

      DATXLIB_SERIALIZE( margin_state, (total_lendable)(total_lent)(least_collateralized)(interest_shares) )
   };
   ...
   struct exchange_state {
      ...
      struct connector {
         ...
         DATXLIB_SERIALIZE( connector, (balance)(weight)(peer_margin) )
      };
      ...
      DATXLIB_SERIALIZE( exchange_state, (manager)(supply)(fee)(base)(quote) )
   };

   typedef datxio::multi_index<N(markets), exchange_state> markets;
