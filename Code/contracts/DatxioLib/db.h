 ...
 *  @brief Defines an interface to DATXIO database
 *  @ingroup database
 *
 *  @details
 *  DATXIO organizes data according to the following broad structure:
 ...
 *  @ingroup database
 *
 *  @details Database C API provides low level interface to DATXIO database.
 *
...
/**
  ...
  *  datxio_assert(itr >= 0, "Alice cannot be removed since she was already not found in the table");
  *  db_remove_i64(itr);
  *  @endcode
  */
...
/**
  ...
  *  datxio_assert(len <= 50, "buffer to small to store retrieved record");
...
/**
  ...
  *  datxio_assert(end_itr < -1, "Charlie was not the last entry in the table");
  *  @endcode
  */
