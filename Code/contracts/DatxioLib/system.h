...
*
    *  @code
    *  datxio_assert(1 == 2, "One is not equal to two.");
    *  datxio_assert(1 == 1, "One is not equal to one.");
    *  @endcode
    *
    *  @param msg - a null terminated string explaining the reason for failure
    */
   void  datxio_assert( uint32_t test, const char* msg );
    ...
    */
   void  datxio_assert_message( uint32_t test, const char* msg, uint32_t msg_len );
    ...
    */
   void  datxio_assert_code( uint32_t test, uint64_t code );
...
*
    ...
    *  @endcode
    */
   [[noreturn]] void  datxio_exit( int32_t code );
