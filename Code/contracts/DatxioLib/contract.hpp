 ...
 * @ingroup types
 * @brief Defines contract type which is %base class for every DATXIO contract
 * 
 * @{
 * 
 */
...
/**
 * @brief %Base class for DATXIO contract.
 * @details %Base class for DATXIO contract. %A new contract should derive from this class, so it can make use of DATXIO_ABI macro.
 */
class contract {
   public:
      /**
