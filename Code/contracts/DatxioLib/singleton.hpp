...
namespace  datxio {
    ...
    *  @brief Defines DATXIO Singleton Table
    *  @ingroup databasecpp 
    *  @{
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         DATXLIB_SERIALIZE( row, (value) )
      };

      typedef datxio::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            datxio_assert( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
