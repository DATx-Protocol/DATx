...
/**
 * @brief DATXIO Public Key
 * @details DATXIO Public Key. It is 34 bytes.
 */
struct public_key {
   char data[34];
};
...
/**
 * @brief DATXIO Signature
 * @details DATXIO Signature. It is 66 bytes.
 */
struct signature {
   uint8_t data[66];
};
...
/**
 * @brief Type of DATXIO Transaction Id
 * @details Type of DATXIO Transaction Id. It is 256-bit hash
 */
