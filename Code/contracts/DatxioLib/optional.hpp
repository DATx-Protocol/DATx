   ...
   class optional {
      public:
         ...
         */
          ...
          */
         T&       operator*()      { datxio_assert(_valid, "dereference of empty optional"); return ref(); }
          ...
          * @return T& - Contained value
          */
         const T& operator*()const { datxio_assert(_valid, "dereference of empty optional"); return ref(); }
         ...
         T*       operator->()
         {
            datxio_assert(_valid, "dereference of empty optional");
            return ptr();
         }
         ...
         *  @return datxio::datastream<Stream>& - Reference to the datastream
         */
         template<typename Stream>
         friend inline datxio::datastream<Stream>& operator>> (datxio::datastream<Stream>& ds, optional& op)
         {
            char valid = 0;
            ds >> valid;
            if (valid) {
         ...
         */
         template<typename Stream>
         friend inline datxio::datastream<Stream>& operator<< (datxio::datastream<Stream>& ds, const optional& op)
         {
